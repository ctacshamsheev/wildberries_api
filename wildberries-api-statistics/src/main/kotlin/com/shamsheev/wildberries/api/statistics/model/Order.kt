...
/**
 * @param date Дата и время заказа. Это поле соответствует параметру `dateFrom` в запросе, если параметр `flag`=1. Если часовой пояс не указан, то берется Московское время (UTC+3).
 ...
 * @param priceWithDisc Цена со скидкой продавца (= `totalPrice` * (1 - `discountPercent`/100))
 * @param isCancel Отмена заказа. true - заказ отменен
 * @param cancelDate Дата и время отмены заказа. Если заказ не был отменен, то \"0001-01-01T00:00:00\". Если часовой пояс не указан, то берется Московское время UTC+3.
...
//    val supplierArticle: String? = null,
//    val nmId: Int? = null,
//    val barcode: String? = null,
//    val category: String? = null,
//    val subject: String? = null,
//    val brand: String? = null,
//    val techSize: String? = null,
